...
public class ChangeTradeOrderQuantityTest {
    @Autowired
    private TradeOrderService tradeOrderService;

    @Test
    public void changeTradeQuantityTest1(){
        try {
            TradeOrderRequestModel requestModel = new TradeOrderRequestModel();
            tradeOrderService.changeTradeQuantity(requestModel);
        } catch (Exception e) {
    ...
    @Test
    public void changeTradeQuantityTest2(){
        try {
            TradeOrderRequestModel requestModel = new TradeOrderRequestModel();
    ...
    @Test
    public void changeTradeQuantityTest3(){
        try {
            TradeOrderRequestModel requestModel = new TradeOrderRequestModel();
    ...
    @Test
    public void changeTradeQuantityTest4(){
        //create trade
        TradeOrderRequestModel requestModel = new TradeOrderRequestModel();
